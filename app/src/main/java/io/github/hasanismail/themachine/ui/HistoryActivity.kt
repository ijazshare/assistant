...
import io.github.hasanismail.themachine.ui.history.HistoryScreen
...
/** What has been asked, what was done about it, and what has been learned. */
@AndroidEntryPoint
        ...
        setContent {
            TheMachineTheme {
                Scaffold(
                    ...
                    HistoryScreen(modifier = Modifier.padding(insets))
                }
            }
        }
    }
